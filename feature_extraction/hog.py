...
class HOG(FeatureExtractionInterface):
    DESCRIPTOR_ALGORITHM = FeatureExtractionAlgorithms.HOG
    ...
    def get_descriptor_details(self):
        descriptor_details = [self.DESCRIPTOR_ALGORITHM,
                              str(self.features_per_cell), str(self.block_size[0]),
